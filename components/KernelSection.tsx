...
export default function KernelSection() {
  ...
  return (
    <section id="kernel" className="min-h-screen snap-start border-t border-hairline py-24 md:py-32">
      <div className="mx-auto flex h-full max-w-[1200px] flex-col justify-center px-6 md:px-10">
        ...
        <div ref={containerRef} className="hscroll flex overflow-x-auto pb-2">
          {steps.map((step, i) => (
            <div
              key={step.num}
              className="w-[180px] flex-none border-r border-hairline p-6 transition-all duration-500 last:border-r-0"
              style={{
                opacity: visible ? 1 : 0,
